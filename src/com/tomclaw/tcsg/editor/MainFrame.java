...
public class MainFrame extends javax.swing.JFrame {
    ...
    /**
     * Returns active com.tomclaw.tcsg.editor panel or null in case of com.tomclaw.tcsg.editor panels doesnt exist
     *
     * @return EditorPanel
     */
    ...
    public void updateScaleFactor(int scaleFactor) {
        /** Obtain com.tomclaw.tcsg.editor panel **/
        EditorPanel editorPanel = getActiveEditorPanel();
        if (editorPanel != null) {
            if (scaleFactor < 1) {
                scaleFactor = 1;
    ...
    private void initComponents() {
        ...
        jButton15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/icon-undo.png"))); // NOI18N
        jButton15.setToolTipText("Отмена последнего примитива");
        ...
        jTable1.setDefaultRenderer(Color.class, new ColorTableRenderer());
    ...
    {//GEN-HEADEREND:event_jButton15ActionPerformed
        EditorPanel t_ePanel = this.getActiveEditorPanel();
        if (t_ePanel != null) {
            Primitive primitiveRemv = t_ePanel.removeLastPrimitive();
            if (primitiveRemv != null && propertiesPanel != null) {
                propertiesPanel.removeAll();
                propertiesPanel.updateUI();
            }
            t_ePanel.updateUI();
